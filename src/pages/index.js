      ...
      <Layout location={location} title={siteTitle}>
        ...
        <section className="home__kano">
          ...
          >
            <h4>Jigoro Kano</h4>
            <p>
              Suočite se sa svojim strahom, ispraznite se, vjerujte svom glasu,
              pustite kontrolu, imajte vjeru u ishode, povežite se s većom
              svrhom, izvucite smisao iz borbe.
            </p>
          </motion.div>
        </section>
