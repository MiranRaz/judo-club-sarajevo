  ...
  return (
    <div className="contact" id="contact">
      ...
      <p className="contact__desc">
        Za sva pitanja, informacije, poslovne projekte, partnerstva i
        sponzorstva slobodno nam se obratite. <br />
        Svi su dobrodošli!
      </p>
      <div className="contact__sections">
        <div className="contact__sections__section">
          ...
          <a href="mailto:jsc@gmail.com">judoclubsarajevo@gmail.com</a>
        </div>
        <div className="contact__sections__section">
